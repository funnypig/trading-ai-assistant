...
from src.app.data.finviz.client import get_headers
from src.app.domain.models import StockDescriptiveInfo, FinancialMetric, OwnershipEntry
...
def _descriptive_loads(s: str) -> StockDescriptiveInfo:
    return StockDescriptiveInfo.from_json(s)
